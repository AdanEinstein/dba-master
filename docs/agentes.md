...
- `dba-ora-monitor` — Monitora e diagnostica Oracle (sessões, locks, top SQL, tablespace, cache, Data Guard) via `ora_monitor`; encerra sessões com `ora_kill_session` quando autorizado.
