...
> Nota MySQL (InnoDB): `UPDATE_TIME` reflete DML (não só DDL) e pode vir `NULL`; nesses casos a fast-path simplesmente não valida e cai no describe completo — nunca serve schema stale.
